...
class Statistics extends StatefulWidget {
  const Statistics(this.currentUser, this.realPriceList, {Key? key})
      : super(key: key);
...
class _StatisticsState extends State<Statistics> {
  ...
  void getStatisticData() {
    ...
    errorForGraph.clear();
    errorForGraph.add(
        GraphData(valueOne: 'error', valueTwo: currentUser.error.toDouble()));
  }
              ...
              children: <Widget>[
                ...
                InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(
                            currentUser.history.length.toString(),
                      ...
                      Row(
                        children: [
                          Text(
                            currentUser.predictions.length.toString(),
                            style: kCardTextStyle3,
                          ),
                          const SizedBox(
                            width: 5,
                  ...
                  onTap: () {
                    Navigator.push(context,
                      ...
                      return PredictionsOnDays(
                          predictionsOnDays, widget.realPriceList);
                    }));
                  },
                ),
                const SizedBox(
                    ...
                    : Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                              width: 60,
                              child: Text(
                                '${currentUser.accuracy.roundToDouble()}%',
                                style: kCardTextStyle,
                    ...
                    : Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                              width: 60,
                              child: Text(
                                '${currentUser.errorStandardDeviation.roundToDouble()}%',
                                style: kCardTextStyle,
                                textAlign: TextAlign.right,
                              )),
                        ],
                    ...
                    : Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                              width: 60,
                              child: Text(
                                '${currentUser.error.roundToDouble()}%',
                                style: kCardTextStyle,
                                textAlign: TextAlign.right,
                              )),
                        ],
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context) {
                                return PredictionAccuracyGraph(currentUser);
                              }));
                            },
                            icon: const Icon(
                              Icons.fullscreen,
                ...
                currentUser.pastPredictions.isEmpty
                    ...
                    : SfLinearGauge(
                        ...
                        barPointers: [
                          for (int i = 0;
                              i < currenciesWithPastPredictions.length;
                              i++)
                            LinearBarPointer(
                              thickness: 25.0,
                              enableAnimation: true,
                              ...
                              child: Center(
                                child: Text(
                                  '${currenciesWithPastPredictions[i]} ${(currentUser.errorStandardDeviationOnCurrencies[currenciesWithPastPredictions[i]]!) > 100 ? 0 : 100 - (currentUser.errorStandardDeviationOnCurrencies[currenciesWithPastPredictions[i]]!).roundToDouble()}%',
                                  style: kCardSmallTextStyle,
                                ),
                              ),
                            ),
                                ...
                                RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                        text:
                                            '${(currentUser.errorStandardDeviationOnCurrencies[currenciesWithPastPredictions[i]]!) > 100 ? 0 : 100 - (currentUser.errorStandardDeviationOnCurrencies[currenciesWithPastPredictions[i]]!).roundToDouble()}%',
                                        style: kCardTextStyle2,
                                      ),
                                    ],
                                  ),
                                ...
                                RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                        text:
                                            '${(currentUser.errorsOnCurrencies[currenciesWithPastPredictions[i]] ?? 0).roundToDouble()}%',
                                        style: kCardTextStyle2,
                                      ),
                                    ],
                                  ),
                ...
                currentUser.pastPredictions.isEmpty
                    ? const Text(
                        'Statistics will be displayed when a prediction is completed.',
