...
import 'package:cryptopal/screens/forecasts/forecasts.dart';
import 'package:cryptopal/screens/market/market.dart';
import 'package:cryptopal/screens/predictions/add_prediction.dart';
import 'package:cryptopal/screens/settings/settings.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  String getBestCryptocurrency() {
    ...
    return minError.isInfinite
        ? '-'
        : cryptocurrencyNames[selectedCryptocurrencies[index]].toString();
  }
            ...
            children: <Widget>[
              ...
              InkWell(
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                          text:
                                              '${getAverageForecastError().roundToDouble()}%',
                                          style: kCardTextStyle2,
                                        ),
                                      ],
                                    ),
                                          ...
                                          widget: RichText(
                                            ...
                                            text: TextSpan(
                                              ...
                                              children: <TextSpan>[
                                                TextSpan(
                                                  text:
                                                      '${(100 - getAverageForecastError()).roundToDouble()}%',
                                                  style: kCardTextStyle,
                                                ),
                                              ],
                                            ),
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return Forecasts(
                        widget.realPriceList, widget.mlPredictionPriceList);
                  }));
                },
              ),
              InkWell(
                ...
                child: glassCard(
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      for (int i = 0;
                          (i < selectedCryptocurrencies.length && i < 5);
                          i++)
                        InkWell(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    '\$ ${kDashboardPriceDisplay(widget.realPriceList[i].pricesList.last.closePrice)}',
                                    style: kCardSmallTextStyle,
                                  ),
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(
                                        width: 60.0,
                                        child: Text(
                                          '${double.parse((widget.realPriceList[i].priceIncreasePercentage).toStringAsFixed(2))}%',
                                          style: TextStyle(
                                            fontSize: 15,
