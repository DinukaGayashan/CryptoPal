      ...
      body: SafeArea(
        child: SizedBox(
          ...
          child: glassCard(
            ...
            ListView(
              children: <Widget>[
                topBar(context, cryptocurrencyNames[widget.currencyIndex]+' Predictions',),
                ...
                Center(
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                          text: ' '+((currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!).abs()>100?0:(currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!-(currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!>0?100:-100)).abs()).roundToDouble().toString()+'%',
                ...
                SfLinearGauge(
                  ...
                  barPointers: [
                    LinearBarPointer(
                      ...
                      value: (currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!).abs()>100?0:(currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!-(currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!>0?100:-100)).abs().roundToDouble(),
                      color: ((currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!).abs()>100?0:(currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!-(currentUser.errorsOnCurrencies[cryptocurrencies[widget.currencyIndex]]!>0?100:-100)).abs())>50?kGreen:kRed,
                  ...
                  GestureDetector(
                      ...
                      child: Center(
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                text: getUserPredictions(currency: cryptocurrencies[widget.currencyIndex],past: true).length.toString(),
                                style: kCardTextStyle2,
                              ),
                            ],
                          ),
                    ...
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){
                        return CurrencyPastPredictions(currentUser, widget.currencyIndex, widget.realPriceList);
                      }));
                    },
                  ),
            GestureDetector(
                  ...
                  child: Center(
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text: (getUserPredictions(currency: cryptocurrencies[widget.currencyIndex]).length-getUserPredictions(currency: cryptocurrencies[widget.currencyIndex],past: true).length).toString(),
                            style: kCardTextStyle2,
                          ),
                        ],
                      ),
                  ...
                  child: SfCartesianChart(
                    ...
                    series: <ChartSeries>[
                      LineSeries<RealPrice, DateTime>(
                        ...
                        name: cryptocurrencies[widget.currencyIndex]+' Close Price',
                        dataSource: getRealPrices(currency: cryptocurrencies[widget.currencyIndex]+'-USD'),
                      ...
                      LineSeries<Prediction, DateTime>(
                        //color: widget.realPriceList[i].priceIncreasePercentage>0?kGreen:kRed,
                        name: cryptocurrencies[widget.currencyIndex]+' Prediction',
                        dataSource: getUserPredictions(currency: cryptocurrencies[widget.currencyIndex]),
                  ...
                  child: SfCartesianChart(
                    ...
                    series: <ChartSeries>[
                      LineSeries<ValueOnCurrency, DateTime>(
                        name: cryptocurrencies[widget.currencyIndex]+' Prediction Error',
                        dataSource: getValuesOnCurrency(currency: cryptocurrencies[widget.currencyIndex], type: 'error'),
                      ...
                      LineSeries<ValueOnCurrency, DateTime>(
                        name: cryptocurrencies[widget.currencyIndex]+' Prediction Error Deviation',
                        dataSource: getValuesOnCurrency(currency: cryptocurrencies[widget.currencyIndex], type: 'variance'),
                        xValueMapper: (ValueOnCurrency data, _) => DateTime.parse(data.date),
